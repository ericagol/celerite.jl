...
function compile_matrix_symm(alpha_real::Vector,alpha_imag::Vector,beta_real::Vector,beta_imag::Vector, w::Vector ,t::Vector,
...
#println("aex, al_small set to zero")
